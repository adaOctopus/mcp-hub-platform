...
import { Play, Zap, CheckCircle, Bot, Upload, DollarSign } from "lucide-react"
...
export default function VisualProcessSection() {
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div className="bg-card/50 backdrop-blur-sm border rounded-xl p-6 relative overflow-hidden">
                  ...
                  <div className="relative z-10">
                    ...
                    <div className="text-center">
                      {/* <h3 className="text-lg font-semibold mb-2">Browse Servers</h3> */}
                ...
                <div className="bg-card/50 backdrop-blur-sm border rounded-xl p-6 relative overflow-hidden">
                  ...
                  <div className="relative z-10">
                    ...
                    {/* Label and step indicator */}
                    <div className="text-center">
                      {/* <h3 className="text-lg font-semibold mb-2">Click & Play</h3> */}
                      <div className="flex items-center justify-center">
          ...
          >
            {activeTab === "server-owner" && (
              <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
                {/* Submit Server - ENHANCED WITH UPLOAD ANIMATION */}
                <div className="bg-card/50 backdrop-blur-sm border rounded-xl p-8 relative overflow-hidden">
                  ...
                  <div className="relative z-10">
                    ...
                    {/* Label and step indicator */}
                    <div className="text-center">
                      {/* <h3 className="text-lg font-semibold mb-2">Submit Server</h3> */}
                      <div className="flex items-center justify-center">
                ...
                {/* Easy Cashout - ENHANCED WITH CASHOUT ANIMATION */}
                <div className="bg-card/50 backdrop-blur-sm border rounded-xl p-8 relative overflow-hidden">
                  <div className="absolute top-0 right-0 w-32 h-32 bg-secondary/10 rounded-full -mr-16 -mt-16"></div>
                  <div className="relative z-10">
                    ...
                    {/* Label and step indicator */}
                    <div className="text-center">
                      {/* <h3 className="text-lg font-semibold mb-2">Easy Monetization</h3> */}
                      <div className="flex items-center justify-center">
                        <div className="w-8 h-8 rounded-full bg-secondary text-white flex items-center justify-center font-bold mt-4">
                          2
                        </div>
